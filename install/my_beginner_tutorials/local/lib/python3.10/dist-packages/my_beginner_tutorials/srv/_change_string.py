...
class Metaclass_ChangeString_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('my_beginner_tutorials')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_ChangeString(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'my_beginner_tutorials.srv.ChangeString')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from my_beginner_tutorials.srv import _change_string
...
class ChangeString(metaclass=Metaclass_ChangeString):
    from my_beginner_tutorials.srv._change_string import ChangeString_Request as Request
    from my_beginner_tutorials.srv._change_string import ChangeString_Response as Response
