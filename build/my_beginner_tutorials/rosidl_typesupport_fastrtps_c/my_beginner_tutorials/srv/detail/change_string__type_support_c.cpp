...
#include "my_beginner_tutorials/srv/detail/change_string__rosidl_typesupport_fastrtps_c.h"
...
#include "my_beginner_tutorials/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _ChangeString_Request__ros_msg_type = my_beginner_tutorials__srv__ChangeString_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_beginner_tutorials
size_t get_serialized_size_my_beginner_tutorials__srv__ChangeString_Request(
  const void * untyped_ros_message,
...
static uint32_t _ChangeString_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_beginner_tutorials__srv__ChangeString_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_beginner_tutorials
size_t max_serialized_size_my_beginner_tutorials__srv__ChangeString_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_beginner_tutorials__srv__ChangeString_Request;
    is_plain =
      (
...
static size_t _ChangeString_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_beginner_tutorials__srv__ChangeString_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_beginner_tutorials, srv, ChangeString_Request)() {
...
using _ChangeString_Response__ros_msg_type = my_beginner_tutorials__srv__ChangeString_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_beginner_tutorials
size_t get_serialized_size_my_beginner_tutorials__srv__ChangeString_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ChangeString_Response__ros_msg_type * ros_message = static_cast<const _ChangeString_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_my_beginner_tutorials__srv__ChangeString_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_beginner_tutorials
size_t max_serialized_size_my_beginner_tutorials__srv__ChangeString_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_beginner_tutorials__srv__ChangeString_Response;
    is_plain =
      (
...
static size_t _ChangeString_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_beginner_tutorials__srv__ChangeString_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_beginner_tutorials, srv, ChangeString_Response)() {
...
// already included above
// #include "my_beginner_tutorials/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "my_beginner_tutorials/srv/change_string.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_beginner_tutorials, srv, ChangeString)() {
