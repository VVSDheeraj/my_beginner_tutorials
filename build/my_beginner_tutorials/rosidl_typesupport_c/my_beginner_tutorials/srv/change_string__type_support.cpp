...
static const _ChangeString_Request_type_support_symbol_names_t _ChangeString_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_beginner_tutorials, srv, ChangeString_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_beginner_tutorials, srv, ChangeString_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_beginner_tutorials, srv, ChangeString_Request)() {
  return &::my_beginner_tutorials::srv::rosidl_typesupport_c::ChangeString_Request_message_type_support_handle;
}
...
static const _ChangeString_Response_type_support_symbol_names_t _ChangeString_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_beginner_tutorials, srv, ChangeString_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_beginner_tutorials, srv, ChangeString_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_beginner_tutorials, srv, ChangeString_Response)() {
  return &::my_beginner_tutorials::srv::rosidl_typesupport_c::ChangeString_Response_message_type_support_handle;
}
...
static const _ChangeString_type_support_symbol_names_t _ChangeString_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_beginner_tutorials, srv, ChangeString)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_beginner_tutorials, srv, ChangeString)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, my_beginner_tutorials, srv, ChangeString)() {
  return &::my_beginner_tutorials::srv::rosidl_typesupport_c::ChangeString_service_type_support_handle;
}
